...
?>
		...
		<div class=" breadcrumb"><?php dmeng_breadcrumb_html
(get_the_ID(),' › ');?></div>
		<?php echo dmeng_adsense('single','top');?>
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="entry-header page-header">
						<h1 class="entry-title h3" itemprop="name"><?php the_title();?><?php //edit_post_link(__('Edit This'), ' <small>', '</small> '); ?></h1>
						<?php dmeng_post_meta();?>
					</div>
				...
				<div class="entry-footer clearfix" role="toolbar"><?php dmeng_vote_html('post',get_the_ID()); dmeng_breadcrumb_html(get_the_ID(),' › ');?>
				</div>
