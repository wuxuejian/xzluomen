...
?>
		<article id="post-<?php the_ID(); ?>" class="panel panel-default panel-headline archive" data-post-id="<?php the_ID(); ?>" role="article" itemscope itemtype="http://schema.org/Article">
				<div class="panel-body">
					<div class="entry-header page-header">
						<h3 class="entry-title"><a href="<?php the_permalink();?>" rel="bookmark" itemprop="url"><span itemprop="name"><?php echo str_replace('{title}', get_the_title(), $home_sticky_posts_title);?></span></a></h3>
					</div>
					<div class="entry-content" itemprop="description"><?php echo get_the_excerpt();?></div>
				</div>
		 </article><!-- #headline -->
<?php
